...
// Endpoints
app.get('/api2/products', (req, res) => res.json(data.products));
app.get('/api2/brands', (req, res) => res.json(data.brands));
app.get('/api2/categories', (req, res) => res.json(data.categories));
app.get('/api2/users', (req, res) => res.json(data.users));
app.get('/api2/cart', (req, res) => res.json(data.cart));
app.get('/api2/orders', (req, res) => res.json(data.orders));
